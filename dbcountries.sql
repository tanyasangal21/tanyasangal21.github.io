...
--
-- Host: localhost
-- Generation Time: Sep 21, 2016 at 10:38 AM
...
INSERT INTO `ngo` (`city`, `state`, `name`, `id`, `sector`, `address`) VALUES
('Naharlagun ', 'Arunachal pradesh', 'ACTION AID SOCIETY ARUNACHAL', 'SR/ITA/1179', 'Civic Issues', 'Action Aid Society Arunachal( AASA) C/O T.Yoka Nea'),
('Itanagar', 'Arunachal pradesh', 'AARRO WELFARE SOCIETY', 'SR/ITA/1389', 'Art & Culture, Environment & Forests, Health & Family Welfare, HIV/AIDS', 'Yahung Tekseng Simar Colony Yingkiong PO/PS Yingki'),
('Itanagar', ' Arunachal pradesh', 'ABO TANI EDUCATIONAL AND CULTURAL SOCIET', 'SR/ITA/277 ', 'Art & Culture, Children, Civic Issues, Education & Literacy, Health & Family Welfare, Rural Development & Poverty Alleviation, Science & Technology, Sports, Tribal Affairs, Urban Development & Poverty Alleviation, Vocational Training, Women''s Development & Empowerment, Youth Affairs', 'Village Kodak, P.O- and P.S- Taliha, Upper Subansi'),
('Roing', 'Arunachal pradesh', 'ESSOMI FOUNDATION TRUST', 'SR/ITA/737/00', 'Animal Husbandry, Dairying & Fisheries, Agriculture, Art & Culture, Civic Issues, Drinking Water, Education & Literacy, Environment & Forests, Food Processing, Health & Family Welfare, Micro Finance (SHGs), Micro Small & Medium Enterprises, Tribal Affairs, Vocational Training, Water Resources, Women''s Development & Empowerment, Youth Affairs', 'Essomi Foundation Trust, Intaya Public School Camp'),
('Naharlagun', 'Arunachal pradesh', 'AAN AAB WELFARE SOCIETY', 'SR/ITS/3251 ', 'Any Other', 'Tili Lower Subansiri District');
